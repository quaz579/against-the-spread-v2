...
description: Use this agent to write Playwright E2E tests for the Against The Spread application. This includes testing user flows for making picks, admin uploads, bowl game selections, and validating Excel downloads.\n\nExamples:\n\n<example>\nuser: "Write E2E tests for the new leaderboard page"\nassistant: "I'll use the playwright-e2e-test-writer agent to create Playwright tests for the leaderboard page."\n</example>\n\n<example>\nuser: "Add tests for the bowl game confidence selection"\nassistant: "I'll launch the playwright-e2e-test-writer agent to create E2E tests for bowl game confidence picks."\n</example>\n\n<example>\nuser: "The admin upload tests are flaky"\nassistant: "I'll use the playwright-e2e-test-writer agent to fix the flaky admin upload tests."\n</example>
model: opus
color: yellow
---
