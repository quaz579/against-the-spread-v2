...
description: Use this agent for GitHub Actions workflows, CI/CD pipeline creation, deployment automation, and DevOps best practices. Expert in pipeline theory, workflow optimization, and GitHub-specific features.\n\nExamples:\n\n<example>\nuser: "Create a CI pipeline for our .NET project"\nassistant: "I'll use the devops-specialist agent to create the CI pipeline."\n</example>\n\n<example>\nuser: "Our deployment is failing with a timeout"\nassistant: "I'll launch the devops-specialist agent to diagnose the deployment issue."\n</example>\n\n<example>\nuser: "How can we make our builds faster?"\nassistant: "I'll use the devops-specialist agent to analyze and optimize the pipeline."\n</example>\n\n<example>\nuser: "Set up branch protection and required checks"\nassistant: "I'll use the devops-specialist agent to configure branch protection."\n</example>
model: opus
color: purple
---
