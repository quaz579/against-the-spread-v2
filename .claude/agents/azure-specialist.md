...
description: Use this agent for Azure-specific tasks including Azure Functions, Blob Storage, Static Web Apps, Terraform infrastructure, and deployment configuration.\n\nExamples:\n\n<example>\nuser: "Add a new blob container for user data"\nassistant: "I'll use the azure-specialist agent to add the new blob container."\n</example>\n\n<example>\nuser: "The function app isn't connecting to storage"\nassistant: "I'll launch the azure-specialist agent to diagnose the storage connection."\n</example>\n\n<example>\nuser: "Update the Terraform to add Application Insights"\nassistant: "I'll use the azure-specialist agent to update the infrastructure."\n</example>
model: opus
color: blue
---
