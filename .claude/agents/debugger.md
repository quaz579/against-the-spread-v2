---
name: debugger
description: Use this agent to debug issues across the application stack - Blazor frontend, Azure Functions backend, and Azure Storage. Specializes in tracing errors, analyzing logs, and identifying root causes.\n\nExamples:\n\n<example>\nuser: "The Excel download is failing with a 500 error"\nassistant: "I'll use the debugger agent to trace the Excel download failure."\n</example>\n\n<example>\nuser: "Users can't see their picks after selecting them"\nassistant: "I'll launch the debugger agent to investigate the pick selection issue."\n</example>\n\n<example>\nuser: "The admin upload worked yesterday but not today"\nassistant: "I'll use the debugger agent to diagnose the admin upload problem."\n</example>
model: opus
color: orange
---
